...
#include "../../cli/file_change_notifier.h"
#include "../../src/container/string_convert.h"
...
public:
    file_change_fixture() {
        ...
        this->file_stream_ =  std::fstream{file_name_, std::ios_base::in || std::ios_base::trunc};
...
TEST_F(file_change_fixture,detects_writing_change){
    ...
    auto sleep_point = std::chrono::steady_clock::now() + std::chrono::milliseconds(250);
